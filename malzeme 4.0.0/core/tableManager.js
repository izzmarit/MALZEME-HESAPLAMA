(function(window) {
    ...
    const TableManager = {
        ...
        initialize() {
            ...
            // Drag and drop sistemini kur
            this.setupDragAndDrop();
        },

        setupDragAndDrop() {
            // Drag state'i takip et
        ...
        handleDragOver(e, index) {
            ...
            // Üzerine gelinen satırı işaretle
        ...
        handleDrop(e, index) {
            ...
            // Sürüklenen satır ile hedef satır aynı değilse
        ...
        handleDragEnd(e) {
            // Tüm drag-over ve dragging sınıflarını temizle
