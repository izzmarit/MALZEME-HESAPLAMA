/**
 * MANŞON (COUPLING) Malzeme Modülü - DÜZELTİLMİŞ VERSİYON
 * Versiyon: 1.0.1
...
(function(window) {
    ...
    class CouplingMaterial extends window.BaseMaterial {
        ...
        calculateCouplingDimensions(couplingTipi, classRating, nps1Data, nps2Data) {
            ...
            const wallIncrease = baseOD * 0.25 * wallThicknessFactor;
        ...
        getDisplayTypeFromRow(rowData) {
            ...
            // DİL DESTEKLİ VERSİYON - getText kullanarak
            let displayKey = '';
            
            if (metadata.coupling_tipi === 'full_coupling') {
                displayKey = 'full_coupling_display';
            } else if (metadata.coupling_tipi === 'half_coupling') {
                displayKey = 'half_coupling_display';
            } else if (metadata.coupling_tipi === 'reducing_coupling') {
                displayKey = 'reducing_coupling_display';
            }
        ...
        formatRow(formData, calculation) {
            ...
            // ASTM öneki ekle
            if (standart === 'asme_b1611' || standart === 'mss_sp97') {
    ...
    console.log('Manşon (Coupling) modülü v1.0.1 yüklendi - Dil desteği düzeltildi');
