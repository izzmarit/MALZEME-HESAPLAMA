 ...
 * Versiyon: 1.0.2 (Düzeltilmiş - Tek Input Seti)
...
(function(window) {
    ...
    class OzelFlansMaterial extends window.BaseMaterial {
        constructor() {
            ...
            this.materials = {
                'P250GH': { density: 7850, standard: 'EN 10028-2', group: 'pressure' },
                ...
                '13CrMo4-5': { density: 7850, standard: 'EN 10028-2', group: 'alloy' },
                '10CrMo9-10': { density: 7850, standard: 'EN 10028-2', group: 'alloy' },
                ...
                '1.4541': { density: 7900, standard: 'EN 10088-2', group: 'stainless', aisi: '321' },
                '1.4462': { density: 7800, standard: 'EN 10088-2', group: 'stainless', aisi: '2205' },
                'A105': { density: 7850, standard: 'ASTM A105', group: 'carbon' },
                'A350 LF2': { density: 7850, standard: 'ASTM A350', group: 'carbon' },
                'A516 Gr.70': { density: 7850, standard: 'ASTM A516', group: 'carbon' },
                'A182 F304': { density: 7900, standard: 'ASTM A182', group: 'stainless' },
                'A182 F316': { density: 7980, standard: 'ASTM A182', group: 'stainless' },
                'A182 F316L': { density: 7980, standard: 'ASTM A182', group: 'stainless' },
                'A182 F321': { density: 7900, standard: 'ASTM A182', group: 'stainless' },
                'A182 F51': { density: 7800, standard: 'ASTM A182', group: 'stainless' }
            };
        ...
        setupEventHandlers() {
            ...
            window.OzelFlansHandlers = {
                onGirisTipiChange: function() {
                    ...
                    const manuelFields = document.getElementById('of_manuelFields');
                    const kayitliFields = document.getElementById('of_kayitliFields');
                    const olcuInputlari = document.getElementById('of_olcuInputlari');
                    
                    const disCapInput = document.getElementById('of_dis_cap');
                    const icCapInput = document.getElementById('of_ic_cap');
                    const kalinlikInput = document.getElementById('of_kalinlik');
                    
                    if (girisTipi === 'manuel') {
                        manuelFields.style.display = 'block';
                        kayitliFields.style.display = 'none';
                        olcuInputlari.style.display = 'block';
                        
                        disCapInput.removeAttribute('readonly');
                        icCapInput.removeAttribute('readonly');
                        kalinlikInput.removeAttribute('readonly');
                        
                        disCapInput.style.background = 'white';
                        icCapInput.style.background = 'white';
                        kalinlikInput.style.background = 'white';
                        disCapInput.style.cursor = 'text';
                        icCapInput.style.cursor = 'text';
                        kalinlikInput.style.cursor = 'text';
                        ...
                        setTimeout(() => {
                            if (disCapInput) disCapInput.focus();
                        }, 100);
                        ...
                        disCapInput.setAttribute('readonly', 'readonly');
                        icCapInput.setAttribute('readonly', 'readonly');
                        kalinlikInput.setAttribute('readonly', 'readonly');
                        
                        disCapInput.style.background = '#f7fafc';
                        icCapInput.style.background = '#f7fafc';
                        kalinlikInput.style.background = '#f7fafc';
                        disCapInput.style.cursor = 'not-allowed';
                        icCapInput.style.cursor = 'not-allowed';
                        kalinlikInput.style.cursor = 'not-allowed';
                        ...
                        manuelFields.style.display = 'none';
                        kayitliFields.style.display = 'none';
                        olcuInputlari.style.display = 'none';
                    }
                },
        ...
        loadKayitliFlanslar() {
            ...
            kayitlar.forEach(kayit => {
                ...
                option.textContent = `${kayit.ad} (Ø${kayit.disCap} - Ø${kayit.icCap} x ${kayit.kalinlik}mm)`;
        ...
        createUI() {
            ...
            return `
                ...
                <!-- Ortak Ölçü Input'ları - Her İki Mod İçin -->
                <div id="of_olcuInputlari" style="display:none;">
                    <div class="form-row">
                        <div class="form-group">
        ...
        validate(formData) {
            const girisTipi = formData.of_giris_tipi;
        ...
        formatDimensions(formData) {
            ...
            return `Ø${disCapStr} - Ø${icCapStr} x ${kalinlikStr}mm`;
        }
    ...
    console.log('Özel Flanş modülü v1.0.2 yüklendi (Tek Input Seti Yaklaşımı)');
