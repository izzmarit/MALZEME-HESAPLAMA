...
(function(window) {
    ...
    class DirsekMaterial extends window.BaseMaterial {
        ...
        getStandard(grade, standart) {
            if (standart === 'en10253' && this.en10253Materials[grade]) {
                return 'EN 10253-2';
            } else if (standart === 'asme_b169' && this.asmeMaterials[grade]) {
                return 'ASME B16.9';
            } else if (standart === 'asme_b1611' && this.asmeMaterials[grade]) {
                return 'ASME B16.11';
            }
            return '-';
        }
        ...
        formatDimensions(formData) {
            ...
            if (standart === 'en10253') {
                ...
                return `${cap} × ${etKalinlik}mm, ${yaricap}, ${aci}°, Tip-${tip}`;
                ...
                return `NPS ${nps}", ${yaricap}, Sch.${schedule}, ${aci}°, ${ucTipi}`;
                ...
                return `NPS ${nps}", Class ${classRating}, ${aci}°, ${ucTipi}`;
            }
        ...
        formatRow(formData, calculation) {
            ...
            // ASTM öneki ekle
            if (standart === 'asme_b169' || standart === 'asme_b1611') {
