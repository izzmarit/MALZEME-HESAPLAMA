                                ...
                                htmlContent = `
                                    <div class="form-row">
                                        <div class="form-group full-width">
                                            ...
                                            <input type="text" id="ozelMalzemeTuru" placeholder="Malzeme türünü yazınız">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group full-width">
                                            <label for="ozelMalzemeCinsi"><span class="label-icon">🔬</span> Malzeme Cinsi (Opsiyonel)</label>
                                            <input type="text" id="ozelMalzemeCinsi" placeholder="İsteğe bağlı">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group full-width">
                                            <label for="ozelMalzemeOlculer"><span class="label-icon">📏</span> Ölçüler (Opsiyonel)</label>
                                            <input type="text" id="ozelMalzemeOlculer" placeholder="Örn: 100x50x10mm">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group full-width">
                                            <label for="ozelMalzemeNorm"><span class="label-icon">📋</span> EN Normu (Opsiyonel)</label>
                                            <input type="text" id="ozelMalzemeNorm" placeholder="Örn: EN 10025">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group">
                                            <label for="ozelMalzemeBirimAgirlik"><span class="label-icon">⚖️</span> Birim Ağırlık (kg)</label>
                                            <input type="number" id="ozelMalzemeBirimAgirlik" step="0.01" min="0" placeholder="0.00">
                                        </div>
                                    </div>
                                `;
                                
                                // Malzeme cinsi alanını varsayılan olarak göster
                                const malzemeCinsiDiv = document.getElementById('malzemeCinsi').parentElement.parentElement;
                                if (malzemeCinsiDiv && tur !== 'ozelMalzeme') {
