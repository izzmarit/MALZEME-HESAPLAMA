                ...
                while (rowIndex <= maxRow) {
                    ...
                    if (row.malzemeTuru && MaterialData.izgaraElemanlari) {
                        ...
                        if (izgaraElemani) {
                            ...
                            // Malzeme cinsini izgara verisinden al
                    ...
                    if (row.malzemeTuru && !row.malzemeTuru.toString().includes('Flanş') && 
                        !row.malzemeTuru.toString().includes('Izgara') &&
                        !['SAC', 'LAMA', 'BORU', 'KOSEBENT', 'KUTU', 'MIL', 'IPE', 'HEA', 
                        'HEB', 'NPU', 'NPI'].includes(row.malzemeTuru.toString().toUpperCase())) {
                        // Standart olmayan bir malzeme türü, özel malzeme olarak işaretle
