        ...
        submenu: [
            {
                ...
                submenu: [
                    {
                        label: 'Yeni Malzeme Türü',
                        click: () => {
                            mainWindow.webContents.send('add-material-type');
                        }
                    },
                    {
                        label: 'Yeni Malzeme Cinsi',
                        click: () => {
            ...
            },
            {
                ...
                click: () => {
                    dialog.showMessageBox(mainWindow, {
                        ...
                        detail: 'Versiyon: 1.0.0\n\n© 2024 TETA Kazan\n\nProfesyonel malzeme hesaplama ve yönetimi için geliştirilmiştir.',
                        buttons: ['Tamam']
                    });
                }
            }
