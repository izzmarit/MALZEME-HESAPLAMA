        ...
        submenu: [
            {
                ...
                click: () => {
                    mainWindow.webContents.send('show-column-manager');
                }
            },
            {
                ...
                click: () => {
                    mainWindow.webContents.send('show-filter-manager');
                }
            },
            { type: 'separator' },
            {
                ...
                click: () => {
                    mainWindow.webContents.send('show-language-settings');
                }
            }
        ]
    },
...
function createWindow() {
    ...
    // Pencere hazır olduğunda göster - DÜZELTME
    mainWindow.once('ready-to-show', () => {
        mainWindow.maximize();
        mainWindow.show();
        
        // Focus sorununu çözmek için eklenecek kodlar
        setTimeout(() => {
            mainWindow.focus();
            mainWindow.webContents.focus();
            
            // İlk input alanına focus gönder
            mainWindow.webContents.executeJavaScript(`
                const firstInput = document.querySelector('input:not([readonly]), select');
                if (firstInput) {
                    firstInput.focus();
                }
            `);
