...
// Global focus yöneticisi - GÜNCELLENMİŞ VERSİYON
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('focus', () => {
        ...
        focusCheckInterval = setInterval(() => {
            const currentActiveElement = document.activeElement; // DEĞİŞKEN ADI DEĞİŞTİRİLDİ
    ...
    // Tıklama olaylarında focus kontrolü
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Dil sistemini başlat - İLK OLARAK BAŞLAT
