...
(function(window) {
    ...
    const ExcelManager = {
        ...
        determineMaterialType: function(rowData) {
            ...
            } else if (malzemeTuruLower.includes('lama') || malzemeTuruLower.includes('plate')) {
            ...
            } else if (malzemeTuruLower.includes('kutu') || malzemeTuruLower.includes('box')) {
                rowData.originalType = 'kutu';
            } else if (malzemeTuruLower.includes('mil') || malzemeTuruLower.includes('shaft')) {
                rowData.originalType = 'mil';
            } else if (malzemeTuruLower.includes('flanş') || malzemeTuruLower.includes('flange')) {
                if (malzemeTuruLower.includes('asme')) {
                    rowData.originalType = 'flansAsme';
                } else if (malzemeTuruLower.includes('özel') || malzemeTuruLower.includes('custom')) {
            ...
            } else if (malzemeTuruLower.includes('ızgara') || malzemeTuruLower.includes('grate')) {
                rowData.originalType = 'izgara';
            } else if (malzemeTuruLower.includes('ipe')) {
                rowData.originalType = 'profil';
                rowData.profilTipi = 'ipe';
            } else if (malzemeTuruLower.includes('hea')) {
                rowData.originalType = 'profil';
                rowData.profilTipi = 'hea';
            } else if (malzemeTuruLower.includes('heb')) {
                rowData.originalType = 'profil';
                rowData.profilTipi = 'heb';
            } else if (malzemeTuruLower.includes('npu')) {
                rowData.originalType = 'profil';
                rowData.profilTipi = 'npu';
            } else if (malzemeTuruLower.includes('npi')) {
                rowData.originalType = 'profil';
                rowData.profilTipi = 'npi';
            } else {
