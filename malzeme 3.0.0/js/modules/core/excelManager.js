            ...
            while (currentRow <= maxRows) {
                ...
                try {
                    ...
                    if (metadataValue) {
                        ...
                        if (metadata.dirsekDetay) rowData.dirsekDetay = metadata.dirsekDetay;  // ✅ EKLENDI
                        if (metadata.ozelMalzemeDetay) rowData.ozelMalzemeDetay = metadata.ozelMalzemeDetay;
                        if (metadata.kosebentDetay) rowData.kosebentDetay = metadata.kosebentDetay;  // ✅ EKLENDI
                        if (metadata.kutuDetay) rowData.kutuDetay = metadata.kutuDetay;  // ✅ EKLENDI
                        if (metadata.lamaDetay) rowData.lamaDetay = metadata.lamaDetay;  // ✅ EKLENDI
                        if (metadata.milDetay) rowData.milDetay = metadata.milDetay;  // ✅ EKLENDI
                        if (metadata.sacDetay) rowData.sacDetay = metadata.sacDetay;  // ✅ EKLENDI
                        if (metadata.profilDetay) rowData.profilDetay = metadata.profilDetay;  // ✅ EKLENDI
                        if (metadata.vanaDetay) rowData.vanaDetay = metadata.vanaDetay;  // ✅ YENİ EKLENEN
