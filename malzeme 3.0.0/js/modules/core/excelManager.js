...
(function(window) {
    ...
    const ExcelManager = {
        ...
        determineMaterialType: function(rowData) {
            ...
            // Özel Flanş kontrolü - flansTipi field'ına bak
            if (rowData.flansTipi) {
            ...
            for (const tip of flansTipleri) {
                if (malzemeTuruLower.includes(tip)) {
                    // Eğer formData'da özel flanş işaretleri varsa
                    if (rowData.flansDetay && (rowData.flansDetay.tipi || rowData.formData)) {
                        rowData.originalType = 'ozelFlans';
                    } else {
            ...
            if (malzemeTuruLower.includes('sac') || malzemeTuruLower.includes('sheet')) {
                ...
                // Genel flanş - özel kontrolleri yukarıda yaptık
                rowData.originalType = 'flans';
