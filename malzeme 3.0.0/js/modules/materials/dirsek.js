...
(function(window) {
    ...
    class DirsekMaterial extends window.BaseMaterial {
        ...
        fillSpecificFields(rowData) {
            ...
            if (rowData.formData && !rowData.dirsekDetay) {
                const fields = ['standartSistem', 'dirsekAci', 'dirsekBoyut', 'dirsekKalinlik'];
                let delay = 0;
                ...
                fields.forEach((field, index) => {
                    setTimeout(() => {
                        ...
                        if (element && rowData.formData[field] !== undefined) {
                            ...
                            if (field === 'standartSistem') window.ApplicationController.updateDirsekStandards();
                            if (field === 'dirsekAci') window.ApplicationController.updateDirsekSizes();
                            if (field === 'dirsekBoyut') window.ApplicationController.updateDirsekThickness();
                            if (field === 'dirsekKalinlik') window.ApplicationController.updateDirsekWeight();
                        }
                    }, delay);
                    delay += 100;
                });
