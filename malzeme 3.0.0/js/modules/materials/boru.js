...
(function(window) {
    ...
    class BoruMaterial extends window.BaseMaterial {
        ...
        fillSpecificFields(rowData) {
            ...
            // İlk önce formData varsa onu kullan
            if (rowData.formData) {
                ...
                if (rowData.formData.standartSistem) {
                    ...
                    if (standartElement) {
                        ...
                        // Standart değişimini tetikle
                        window.ApplicationController.updatePipeStandards();
                    }
                }
                
                // 100ms bekle, sonra diğer alanları doldur
                setTimeout(() => {
                    // Çap ve kalınlık
                        ...
                        setTimeout(() => {
                            ...
                            if (dnElement) {
                                ...
                                setTimeout(() => {
                                    ...
                                    if (thicknessElement && rowData.formData.enThickness) {
                        ...
                        setTimeout(() => {
                            ...
                            if (npsElement) {
                                ...
                                setTimeout(() => {
                                    ...
                                    if (scheduleElement && rowData.formData.schedule) {
                ...
                return; // formData varsa olculer'e bakma
            }
            
            // formData yoksa olculer'den parse et
            if (rowData.olculer) {
