        ...
        fillSpecificFields(rowData) {
            ...
            if (rowData.olculer) {
                ...
                if (uzunlukMatches) {
                    ...
                    if (uzunlukElement) uzunlukElement.value = uzunlukMatches[1];
                }
            }
            
            // FormData'dan doldur
            if (rowData.formData) {
                if (rowData.formData.profilTipi) {
                    const element = document.getElementById('profilTipi');
                    if (element) {
                        element.value = rowData.formData.profilTipi;
                        window.ApplicationController.updateProfileSizes();
                ...
                if (rowData.formData.uzunluk) {
                    const uzunlukElement = document.getElementById('uzunluk');
                    if (uzunlukElement) uzunlukElement.value = rowData.formData.uzunluk;
                }
            }
        }
    }
