...
(function(window) {
    ...
    class OzelMalzemeMaterial extends window.BaseMaterial {
        ...
        fillSpecificFields(rowData) {
            // ÖNCELİKLE: Malzeme adını ayarla
            ...
            if (!rowData.formData || !rowData.formData.malzemeTipiSecim) {
                const olculer = rowData.olculer ? rowData.olculer.toString() : '';
                ...
                if (olculer.includes('x') && olculer.includes('mm')) {
                    ...
                    if (malzemeTipiElement) {
                        ...
                        if (matches) {
                            setTimeout(() => {
                                if (matches[1]) document.getElementById('olcu1').value = matches[1];
                                if (matches[2]) document.getElementById('olcu2').value = matches[2];
                                if (matches[3]) document.getElementById('olcu3').value = matches[3];
                                if (matches[4]) document.getElementById('olcu4').value = matches[4];
                            }, 200);
                        }
                    }
                    ...
                    if (rowData.formData) {
                console.log('Özel Malzeme formData bulundu:', rowData.formData);
