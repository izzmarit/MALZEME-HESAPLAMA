...
(function(window) {
    ...
    class OzelFlansMaterial extends window.BaseMaterial {
        ...
        formatRow(formData, calculation) {
            ...
            // ÖZEL FLANŞ MARKER EKLE - Bu sayede Excel'den okurken ayırt edilebilir
            baseRow.isOzelFlans = true;
            ...
            // originalType'ı açıkça belirt
            baseRow.originalType = 'ozelFlans';
    ...
    if (!window.ApplicationController.loadFlansTemplate) {
        ...
        if (!window.ApplicationController.deleteFlansTemplate) {
            window.ApplicationController.deleteFlansTemplate = function() {
                ...
                if (!templateName) {
                    if (window.ApplicationController.showCustomAlert) {
                        window.ApplicationController.showCustomAlert('Lütfen silinecek şablonu seçin');
                    } else {
                ...
                window.ApplicationController.showCustomConfirmModal(
                    ...
                    () => {
                        ...
                        if (window.ApplicationController.showCustomAlert) {
                            window.ApplicationController.showCustomAlert(instance.getText('template_deleted') + ': ' + templateName);
                        } else {
