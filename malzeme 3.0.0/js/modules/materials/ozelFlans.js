...
(function(window) {
    ...
    class OzelFlansMaterial extends window.BaseMaterial {
        ...
        createUI() {
            ...
            return `
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="delikSayisi">${this.getText('delik_sayisi_label')}</label>
                        <input type="number" id="delikSayisi" 
                               placeholder="${this.getText('delik_sayisi_placeholder')}" 
                               min="0" step="1">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label for="delikCapi">${this.getText('delik_capi_label')}</label>
                        <input type="number" id="delikCapi" 
                               placeholder="${this.getText('delik_capi_placeholder')}" 
                               min="0" step="any">
                    </div>
                    <div class="form-group">
        ...
        formatDimensions(formData) {
            const flansAdi = formData.flansAdi || '';
            const standart = formData.standart || 'Özel';
            
            return `${flansAdi} (${standart})`;
        }
