    ...
    const ExcelManager = {
        ...
        exportToExcel: async function() {
            ...
            try {
                ...
                // Worksheet oluştur - GÜNCELLENMIŞ pageSetup
                const worksheet = workbook.addWorksheet('Sheet1', {
                    pageSetup: {
                        paperSize: 9, // A4
                        scale: 73,
                        orientation: 'portrait',
                        fitToPage: false,  // fitToPage'i false yapıyoruz
                        fitToWidth: 1,     // Genişlik olarak 1 sayfaya sığdır
                        fitToHeight: 0,    // Yükseklik sınırı yok (0 = sınırsız)
                        ...
                        printArea: null,
                        rowBreaks: []  // Başlangıçta boş, sonradan dolacak
                    }
                });
                ...
                // Özet raporu ekle (verinin bittiği yerden itibaren)
        ...
        addProjectInfo: function(worksheet, projectInfo) {
            ...
            const values = [
                ...
                { cell: 'G3', value: projectInfo.resimAciklamasi || '', size: 14 },
