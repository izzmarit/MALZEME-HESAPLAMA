        ...
        addLogo: function(worksheet) {
            try {
                ...
                if (app.isPackaged) {
                    ...
                    const possiblePaths = [
                        path.join(resourcesPath, 'app.asar.unpacked', 'src', 'assets', 'logo.png'),
                        path.join(resourcesPath, 'app', 'src', 'assets', 'logo.png'),
                        path.join(app.getPath('exe'), '..', 'resources', 'logo.png')
                    ];
                    ...
                    // Development için mevcut yollar
                    const possiblePaths = [
                ...
                if (logoPath) {
                    ...
                    console.log('Logo başarıyla eklendi:', logoPath);
                } else {
