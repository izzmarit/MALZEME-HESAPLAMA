...
const menuTemplate = [
    ...
    },
    {
        ...
        submenu: [
            {
                label: 'Malzeme Türlerini Yönet',
                click: () => {
                    mainWindow.webContents.send('manage-material-types');
                }
            },
            {
                label: 'Malzeme Cinslerini Yönet',
                click: () => {
                    mainWindow.webContents.send('manage-material-grades');
                }
            },
            { type: 'separator' },
            {
                label: 'Malzeme Verilerini Dışa Aktar',
                click: () => {
                    mainWindow.webContents.send('export-material-data');
                }
            },
            {
                label: 'Malzeme Verilerini İçe Aktar',
                click: () => {
                    mainWindow.webContents.send('import-material-data');
                }
            }
        ]
    },
...
function createWindow() {
    ...
    // FOCUS SORUNUNU ÇÖZEN KISIM - EKLE
    mainWindow.on('blur', () => {
        // Pencere focus kaybettiğinde
    });
    
    mainWindow.on('focus', () => {
        // Pencere focus kazandığında webContents'e de focus ver
        mainWindow.webContents.focus();
    });
    
    // Modal veya dialog işlemlerinden sonra focus'u geri ver
