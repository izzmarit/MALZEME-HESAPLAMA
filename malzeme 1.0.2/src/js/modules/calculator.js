...
(function(window) {
    ...
    calculateCustomType: function(tur, yogunluk) {
        ...
        if (typeData.hesaplamaTipi === 'birimAgirlik') {
            ...
            // Malzeme cinsi ve standart bilgilerini sakla
            this.currentCalculation.customMalzemeCinsi = malzemeCinsiInput ? malzemeCinsiInput.value : '';
            this.currentCalculation.customStandart = standartInput ? standartInput.value : '';
