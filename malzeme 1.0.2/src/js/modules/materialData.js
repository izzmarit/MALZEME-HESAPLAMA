...
(function(window) {
    ...
    // Ölçü alan tipleri tanımlaması
    OLCU_ALAN_TIPLERI: [
        { kod: 'kalinlik', ad: 'Kalınlık', tip: 'sayi', sembol: 't' },
        { kod: 'en', ad: 'En', tip: 'sayi', sembol: 'w' },
        { kod: 'boy', ad: 'Boy', tip: 'sayi', sembol: 'l' },
        { kod: 'genislik', ad: 'Genişlik', tip: 'sayi', sembol: 'w' },
        { kod: 'uzunluk', ad: 'Uzunluk', tip: 'sayi', sembol: 'L' },
        { kod: 'yukseklik', ad: 'Yükseklik', tip: 'sayi', sembol: 'h' },
        { kod: 'cap', ad: 'Çap', tip: 'cap', sembol: 'Ø' },
        { kod: 'disCap', ad: 'Dış Çap', tip: 'cap', sembol: 'Ød' },
        { kod: 'icCap', ad: 'İç Çap', tip: 'cap', sembol: 'Øi' },
        { kod: 'etKalinlik', ad: 'Et Kalınlığı', tip: 'sayi', sembol: 's' },
        { kod: 'kenar1', ad: 'Kenar 1', tip: 'sayi', sembol: 'a' },
        { kod: 'kenar2', ad: 'Kenar 2', tip: 'sayi', sembol: 'b' },
        { kod: 'radius', ad: 'Yarıçap', tip: 'sayi', sembol: 'r' },
        { kod: 'aci', ad: 'Açı', tip: 'sayi', sembol: '°' },
        { kod: 'derinlik', ad: 'Derinlik', tip: 'sayi', sembol: 'd' }
    ],
    ...
    addMaterialType: function(kod, ad, olcuAlanlari, birim, hesaplamaTipi) {
        ...
        // Kod kontrolü
        if (this.MALZEME_TURLERI[kod] || customTypes[kod]) {
            console.error('Bu kod zaten kullanımda:', kod);
            return false;
        }
        ...
        console.log('Malzeme türü eklendi:', kod, customTypes[kod]);
        return true;
    },
    ...
    // localStorage yazma işlemini geciktirmek için
    _saveTimeout: null,

    saveCustomMaterialTypes: function(types) {
        // Eski timeout'u iptal et
        if (this._saveTimeout) {
            clearTimeout(this._saveTimeout);
        }
        
        // Yeni timeout ayarla (100ms gecikme ile)
    ...
    deleteMaterialType: function(kod) {
        ...
        if (customTypes[kod]) {
            ...
            // Hemen kaydetme yerine geciktirilmiş kaydetme
            this.saveCustomMaterialTypes(customTypes);
            
            const malzemeTuruSelect = document.getElementById('malzemeTuru');
            if (malzemeTuruSelect && malzemeTuruSelect.value === kod) {
                malzemeTuruSelect.value = '';
