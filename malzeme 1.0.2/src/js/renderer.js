...
window.addNewMaterialType = function() {
    ...
    // Hesaplama tipi birim ağırlık ise ölçü alanlarına gerek yok
    let olcuAlanlari = [];
    if (hesaplamaTipi !== 'birimAgirlik') {
        ...
        olcuAlanlari = window.selectedFieldOrder;
    }
    
    // MaterialData modülüne ekle
    if (MaterialData.addMaterialType(kod, ad, olcuAlanlari, unit, hesaplamaTipi)) {
