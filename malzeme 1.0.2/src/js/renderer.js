    ...
    if (confirm(`"${kod}" malzeme türünü silmek istediğinizden emin misiniz?`)) {
        try {
            if (MaterialData.deleteMaterialType(kod)) {
                ...
                // Modal'ı düzgün kapat
                UIManager.closeModal();
                
                // Focus'u geri ver ve modal'ı aç
            ...
            console.error('Malzeme türü silme hatası:', error);
            UIManager.showNotification('Silme işlemi sırasında hata oluştu', 'error');
        ...
        // İptal durumunda focus'u geri ver
        if (currentActiveElement) {
            currentActiveElement.focus();
        }
    }
